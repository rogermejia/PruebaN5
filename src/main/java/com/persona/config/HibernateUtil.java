	...
	public static SessionFactory getSessionFactory() {
		...
		if (sessionFactory == null) {
			...
			try {
				...
				settings.put(Environment.URL, "jdbc:mysql://localhost:3306/personatest?useSSL=false");
				...
				configuration.addAnnotatedClass(Datos.class);
			...
			System.out.println("La petición ya venía llena");
		}
